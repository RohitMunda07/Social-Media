          ...
          <div className="mt-6 space-y-4">
            {[
              ...
              },
              {
                ...
                title: "Share Stories",
                text: "Express yourself with rich media",
                color: "bg-purple-500",
              },
              {
                icon: <Heart size={24} className="text-white" />,
                title: "Build Community",
                text: "Create meaningful relationships",
                color: "bg-pink-500",
              },
            ].map((feature, i) => (
              <div
              ...
              >
                <div
                  className={`${feature.color} p-3 rounded-full flex items-center justify-center`}
                >
                  {feature.icon}
                </div>
                <div>
